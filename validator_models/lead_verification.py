...
APOLLO_API_KEY = os.getenv("APOLLO_API_KEY", "O9ZubNLlw3uUKMiPyaFYJw")
...
async def verify_industry(lead: dict) -> Tuple[bool, float, dict]:
    ...
    print(f"   ⚠️  No company description available for verification. Returning neutral confidence.{predicted, confidence, metadata}")
    return True, 0.5, {
        "checked": False,
...
if __name__ == "__main__":
    async def test():
        ...
        test_lead = {
            "company": "Forbes",
            "industry": "publishing",
            "company_description": "Forbes is a leading American business media company, recognized for its flagship publication, *Forbes* magazine, which has been in circulation since 1917. Headquartered in Jersey City, New Jersey, Forbes has established a strong reputation as one of the oldest and most influential business periodicals in the United States. The company is owned by Integrated Whale Media Investments and is led by Steve Forbes as chairman and editor-in-chief, with Sherry Phillips serving as CEO.\n\nForbes publishes its magazine eight times a year and offers international editions in Asia and licensed versions in 27 countries. The company is well-known for its influential rankings, including the *Forbes 400*, *Forbes 30 Under 30*, and *The World’s Billionaires*. In addition to print, Forbes provides digital media content through its website, featuring news and analysis. The company also hosts various business and leadership events, connecting professionals and thought leaders in the industry. Its audience includes business executives, entrepreneurs, investors, and policymakers seeking in-depth analysis and insights into the business world."
        }
        ...
        if APOLLO_API_KEY:
            ...
            test_lead_role = {
                "email": "kdavis@forbes.com",  # Replace with real email to test
                "role": "Associate Director of Content Marketing",
                "company": "Forbes"
            }
